...
public interface ICheckNoticeDao extends CrudRepository<CheckNoticeForm, String>{
	...
	@Query(value="from CheckNoticeForm c where c.solveScheme.history.outpatientRegistration.medicalCard.cardId=?1 and c.mcheckComment!='已处理' order by c.mcheckTime desc")
